...
(function($) {
    ...
    $.scPlayer = function(options, node) {
        ...
        $player
            .find('.sc-controls')
            .append('<div class="button-wrap m-play"><a href="#play" class="sc-play"><img src="assets/img/play.svg" alt="play"></a> Play</div> <div class="button-wrap m-pause"><a href="#pause" class="sc-pause"><img src="assets/img/pause.svg" alt="Pause"></a> Pause</div>')
            .end()
            .append('<div class="sc-scrubber d-none"></div>')
            .find('.sc-scrubber')
        ...
        $player.bind('onTrackDataLoaded.scPlayer', function(event) {
            ...
            $.each(tracks, function(index, track) {
                ...
                $('<li><a href="' + track.permalink_url + '">' + track.title.substring(0, 40) + '</a></li>').data('sc-track', {
                    id: index
